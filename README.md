...
FLOWAY_AGENTS=claude-code,codex floway install   # subset; ids: claude-code codex oh-my-pi pi opencode zed vscode deepseek-harness
```
...
| Pi | `~/.pi/agent/models.json` (full model catalog with limits/costs, 0600) |
